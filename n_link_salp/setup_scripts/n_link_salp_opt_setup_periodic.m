...
solver_config.local_force_func = getMinGaitForceFunctionFeedback(T, n, q_init, B_aug, domain, q_dot_des, thrust_angle, omega, bias_constant_jets, max_force_thrust);
...
anim_config.gif_name = ['link_' num2str(2) '_t_angle_' num2str((180/pi)*thrust_angle) 'period_' num2str(T) '_move_y']; 
