...
r_init = zeros([1, n - 1]);  % Initial shape of the system
r_init = zeros([1, n-1]) + (2*rand(1, n-1) - 1)*(pi/8);
...
local_force_func = getMinGaitForceModFunction(n, q_init, B_aug, domain, q_dot_des(1:3), thrust_angle, omega);
solver_config.local_force_func = local_force_func;
